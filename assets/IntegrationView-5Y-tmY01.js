import{a as S,b as $,r as w,u as A,M as U,Y as L,c as u,d as i,w as m,e as c,_ as R,i as h,O as F,P as x,g as C,Z as N,j as f,F as K,k as V,$ as B,a0 as T,h as M,f as d,Q as O,t as _,I as H,l as p,n as W,a1 as j}from"./index-D0hKoGh3.js";const z={class:"grid grid-cols-1 md:grid-cols-2 gap-6"},Q={class:"font-sans text-wrap mb-6"},X={key:0,class:"text-lg"},Y={key:1,class:"text-lg"},q={class:"space-x-2"},J={__name:"IntegrationView",setup(E){const I=S(),k=$(),y="https://discord.com/oauth2/authorize?client_id=947985989421395988&response_type=code&redirect_uri=https%3A%2F%2Fweb3.phaseii.network%2F%23%2Fprofile%2Fintegrate%2Fdiscord&scope=identify",b="https://kamai.tachi.ac/oauth/request-auth?clientID=CIce4260e1939ceed11c8e48ee857a3aef2a87ba56",g=w(I.params.service);if(g.value){const t=new URLSearchParams(window.location.search),l=t.get("code");t.delete("code"),l!==void 0&&P(g.value,l)}const r=A(),e=w(r.userData);U(()=>r.userData,t=>{e.value=t});const v=[{id:"discord",name:"Discord",icon:B,oAuth:y,description:`Linking your Discord account to PhaseII gives you an avatar, enables push notifications, and more via our Discord bot, BadManiac.
